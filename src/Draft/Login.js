      ...
      <div className="flex justify-center items-center h-full ">
        ...
        <form className="max-w-[500px] w-full mx-auto bg-white p-8 rounded-3xl ">
          ...
          <div className="flex justify-between py-8">
            <p className='border shadow-lg hover:shadow-xl px-12 py-2 relative flex items-center'><AiFillFacebook className='mr-2'/> Facebook</p>
            <p className='border shadow-lg hover:shadow-xl px-12 py-2 relative flex items-center'><FcGoogle className='mr-2' /> Google
            </p>
          </div>
          {/*Div to take care of the name  */}
          <div className='flex flex-col mb-4'>
            <label className='ml-5 font-bold text-2xl '>Name: </label>
            <input className='border relative bg-gray-200 p-5' type="text" />
          </div>
          ...
          <button className='w-full py-3 mt-8 bg-yellow-600 hover:bg-yellow-500 rounded-3xl relative text-white'>Sign In</button>
        </form>
      </div>
    </div>
